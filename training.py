...
if __name__ == '__main__':
	...
	for i in range(episodes):
		...
		reward_value.append(sum(reward.values()))
		pe_value.append(total_pe)
	...
	plt.savefig('Training/' + dataset_name + '/' + run_time + '_' + str(episodes) + '_' + 'loss.png')

	plt.plot(reward_value)
	plt.xlabel('Episode')
	plt.ylabel('Total Reward')
	plt.savefig('Training/' + dataset_name + '/' + run_time + '_' + str(episodes) + '_' + 'reward.png')

	plt.plot(pe_value)
	plt.xlabel('Episode')
	plt.ylabel('Total PE')
	plt.savefig('Training/' + dataset_name + '/' + run_time + '_' + str(episodes) + '_' + 'total_PE.png')
